import os
from calculadora import Basico, Cadena, CalEstandar,CalCientifica, Intermedio, TratamientodeLista
        ...
        while opc1 != "11":
            ...
            if opc1 == "1":
                ...
                for x in range(num):
                    ...
                    lista.append(valor)
                aux=lista    
                resultado = TratamientodeLista(lista)
                ...
                diccionario=[{'nombre':'Brando', 'nota':100},{'nombre':'Moises','nota':80},{'nombre':'Sandra','nota':90}]
                resultado = TratamientodeLista(diccionario)
                ...
                tupla = (2,6,8,4,1,9,10)
                resultado = TratamientodeLista(tupla)
